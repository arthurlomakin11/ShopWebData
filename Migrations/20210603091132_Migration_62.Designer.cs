...
namespace ShopWebData.Migrations
{
    ...
    [Migration("20210603091132_Migration_62")]
    partial class Migration_62
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopWebData.DeliveryPriceTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("StartCartPrice")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("DeliveryPriceTags");
                });
            ...
            modelBuilder.Entity("ShopWebData.MenuItem", b =>
                {
                    ...
                    b.Property<bool>("AtTheEndOfTheMenu")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("MobileParentId")
                        .HasColumnType("int");

                    b.Property<bool>("MobileShowInMenu")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ShopWebData.ProductCollection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopWebData.ProductInCollection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProductsInCollection");
                });
            ...
            modelBuilder.Entity("ShopWebData.Shop", b =>
                {
                    ...
                    b.Property<DateTime>("EndPickupTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime>("StartPickupTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ShopWebData.MenuItem", b =>
                {
                    b.HasOne("ShopWebData.MenuItem", "MobileParent")
                        .WithMany()
                        .HasForeignKey("MobileParentId");

                    b.HasOne("ShopWebData.MenuItem", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId");

                    b.Navigation("MobileParent");
            ...
            modelBuilder.Entity("ShopWebData.ProductInCollection", b =>
                {
                    b.HasOne("ShopWebData.ProductCollection", null)
                        .WithMany("Products")
